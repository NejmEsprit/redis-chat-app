...
const ChatBottomBar = () => {
  ...
  }, [currentUser?.id, selectedUser?.id, queryClient, playNotification, soundEnabled])
  ...
  return (
    <div className='p-2 flex justify-between w-full items-center gap-2'>
      ...
      <AnimatePresence>
        ...
        {message.trim() ? (
          <Button
            className='h-9 w-9 dark:bg-muted dark:text-muted-foreground dark:hover:bg-muted drak:hover:text-white shrink-0'
            variant={'ghost'}
            size={'icon'}
